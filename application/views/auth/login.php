<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <div class="form-group has-feedback">
      ...
      <input type="text" id="username" name="identity" class="form-control" placeholder="No.Register / Username" required="required" autofocus />
      <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
    </div>
    <div id="password" class="form-group has-feedback">
      <label><?php echo lang('login_password_label') ?></label>
      <input type="password" id="passwordval"  data-toggle="password" name="password" class="form-control" placeholder="<?php echo lang('login_password_label') ?>" required="required" />
    </div>
