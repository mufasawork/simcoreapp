...
<div class="row">
    <div class="col-sm-4">
        <div class="bg-white px-4 py-4 rounded shadow">
            ...
            <a href="<?=base_url()?>admin/pengguna/index/edit/<?= $profile_pengguna->id_customer?>" class="btn btn-block bg-green-light text-white" data-original-title="" title=""><b>Edit Data</b></a>
        </div>
    </div>
